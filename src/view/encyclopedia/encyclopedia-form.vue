  ...
  async created() {
    ...
    this.$watch(
      ...
      Utils.debounce(func => {
        ...
        if (this.form.name.endsWith('山')) this.form.item_type = Number(this.item_types[0].item_code)
        else if (this.form.name.endsWith('水')) this.form.item_type = Number(this.item_types[1].item_code)
        ...
        else if (this.form.name.endsWith('虫')) this.form.item_type = Number(this.item_types[4].item_code)
        ...
        else if (this.form.name.endsWith('國')) this.form.item_type = Number(this.item_types[10].item_code)
        else if (this.form.name.endsWith('金')) this.form.item_type = Number(this.item_types[14].item_code)
      }, 1000),
    ),
      this.$watch(
        'form.original_text',
      ...
      this.$watch(
        'form.guozhu',
        Utils.debounce(func => {
          this.form.guozhu = this.form.guozhu.replace('，郭璞注', '').replace('。郭璞注', '')
          //reg.exec(this.form.original_text).toString()
        }, 1000),
      )
  },
