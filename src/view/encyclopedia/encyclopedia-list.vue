<template>
  <div>
      ...
      <div class="header">
        ...
        <div class="header-right">
          ...
          <el-button
            ...
            @click="
              () => {
                ;(showEdit = true), (this.edit_item_id = null)
              }
            "
            >新增</el-button
          >
    ...
    <!-- 编辑页面 -->
    <encyclopedia-form v-else @editClose="editClose" :edit_item_id="edit_item_id"></encyclopedia-form>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      tableColumn: [
        { prop: 'item_type_name', label: '所属类别', align: 'center' },
