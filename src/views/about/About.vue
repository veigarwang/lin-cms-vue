      ...
      <div class="quantity-item">
        <div class="quantity-detail">
          <div class="quantity-detail-box">
            ...
            <div class="quantity">{{visit.total_visits_count}}</div>
          </div>
        </div>
      ...
      <div class="quantity-item">
        <div class="quantity-detail">
          <div class="quantity-detail-box">
            ...
            <div class="quantity-border-line"></div>
            <div class="quantity">{{visit.total_user_count}}</div>
          </div>
        </div>
        <div class="quantity-icon">
          <img src="../../assets/img/about/icon.png" alt />
      ...
      <div class="quantity-item">
        <div class="quantity-detail">
          <div class="quantity-detail-box">
            ...
            <div class="quantity-border-line"></div>
            <div class="quantity">{{visit.month_visits_count}}</div>
          </div>
        </div>
        <div class="quantity-icon">
          <img src="../../assets/img/about/icon.png" alt />
      ...
      <div class="quantity-item">
        <div class="quantity-detail">
          <div class="quantity-detail-box">
            ...
            <div class="quantity-border-line"></div>
            <div class="quantity">{{visit.month_user_count}}</div>
          </div>
        </div>
        <div class="quantity-icon">
          <img src="../../assets/img/about/icon.png" alt />
...
<script>
import logApi from '@/lin/models/log'
export default {
  data() {
    return {
      activeName: 'first',
  ...
  methods: {
    ...
    async getUserAndVisits() {
      this.visit = await logApi.getUserAndVisits()
    },
  },
}
</script>
