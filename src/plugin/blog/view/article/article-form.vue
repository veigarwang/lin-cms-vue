          ...
          <el-col :lg="24"
            ...
            <el-form :model="form"
              ...
              <el-row>
                ...
                <el-col :lg="6">
                  <el-form-item label="随笔类型"
                    prop="excerpt">
                    <el-select disabled
                      v-model="form.article_type"
                      filterable
                      default-first-option>
                      <el-option v-for="item in article_types"
                ...
                <el-col :lg="12">
                  <el-form-item label="标签"
                    ...
                    <el-select disabled
                      ...
                      :loading="loading"
                      default-first-option>
                      <el-option v-for="item in form.tags"
                        :key="item.id"
                        :label="item.tag_name"
              ...
              <el-row>
                <el-col :lg="12">
                  <el-form-item label="状态"
                    prop="is_audit">
                    <el-radio v-model="form.is_audit"
                      :label="true">审核通过</el-radio>
                    <el-radio v-model="form.is_audit"
                      :label="false">拉黑</el-radio>
                  </el-form-item>
                </el-col>
                <el-col :lg="12"></el-col>
              </el-row>
